...
# Dependency to inject StoreService not used for background processing
# def get_store_service(lattice_collection: Collection = Depends(get_lattice_collection)):
#     """
...
#     """
#     return StoreService(lattice_collection=lattice_collection)
